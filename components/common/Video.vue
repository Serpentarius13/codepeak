<template>
  <div
    class="video-box relative z-[600] flex aspect-video h-[85vh] w-screen overflow-hidden"
    ref="videoContainer"
    @mouseenter="openNav"
    @mouseleave="closeNav"
  >
    ...
    <Transition name="nav">
      <div
        ...
        v-if="isNavOpened"
      >
        <nav class="flex flex-wrap items-center gap-[2.4rem] md:justify-end">
          ...
          <button @click="toggleFullscreen">
            <NuxtIcon
              :name="
                isFullScreen ? 'video/fullscreen-on' : 'video/fullscreen-off'
              "
            />
          </button>
          ...
          <button @click="togglePictureInPicture">
            <NuxtIcon
              :name="
                isPictureInPicture ? 'video/picture-on' : 'video/picture-off'
              "
            />
          </button>
        </nav>
